...
//-----------------------------------------------------------------------------
// xod/core/pwm_output implementation
//-----------------------------------------------------------------------------
...
using input_DUTY = InputDescriptor<Number, offsetof(Wiring, input_DUTY)>;
...
namespace xod {
    ...
    constexpr Number node_0_output_VAL = 9;
    ...
    constexpr Number node_1_output_VAL = 0.5;
    ...
    // Storage of #2 xod/core/cube
    constexpr Number node_2_output_OUT = 0;
    xod__core__cube::Storage storage_2 = {
        { }, // state
        node_2_output_OUT

    };

    // Storage of #3 xod/core/pwm_output

    xod__core__pwm_output::Storage storage_3 = {
        { }, // state
    };
    ...
    const NodeId outLinks_1_VAL[] PROGMEM = { 2, NO_NODE };
    ...
    // Wiring of #2 xod/core/cube
    const NodeId outLinks_2_OUT[] PROGMEM = { 3, NO_NODE };
    const xod__core__cube::Wiring wiring_2 PROGMEM = {
        &xod__core__cube::evaluate,
        // inputs (UpstreamPinRef’s initializers)
        { NodeId(1),
            xod__core__constant_number::output_VAL::INDEX,
            xod__core__constant_number::output_VAL::STORAGE_OFFSET }, // input_IN
        // outputs (NodeId list binding)
        outLinks_2_OUT // output_OUT
    };

    // Wiring of #3 xod/core/pwm_output
    const xod__core__pwm_output::Wiring wiring_3 PROGMEM = {
        &xod__core__pwm_output::evaluate,
        // inputs (UpstreamPinRef’s initializers)
        { NodeId(0),
            xod__core__constant_number::output_VAL::INDEX,
            xod__core__constant_number::output_VAL::STORAGE_OFFSET }, // input_PORT
        { NodeId(2),
            xod__core__cube::output_OUT::INDEX,
            xod__core__cube::output_OUT::STORAGE_OFFSET }, // input_DUTY
        // outputs (NodeId list binding)
    };
